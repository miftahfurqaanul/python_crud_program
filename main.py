# ===================================
# [Entry Data Score Student]
# ===================================
# Developed by. [Miftah Furqaanul Haq]
# JCDS - [Class Batch]
...
score_student_list={
    ...
    "parent": ["joko","jodi","jumadi","jajak","jopi"],
    "place": ["bomas","kedanyang","cerme","giri","sidomukti"],
    "weight": [90,80,70,80,85],
    "height": [150,180,170,160,175],
    ...
    while  True:
        try:
            ...
            # 3 detail student
                ...
                print("NIS   | nama siswa |  gender    | parent     |  place      |  height    |  wight ")
                for i in range(len(score_student_list["name"])):
                    print(f' {score_student_list["NIS"][i]:<4} | {score_student_list["name"][i]:<10} | {score_student_list["gender"][i]:<10} | {score_student_list["parent"][i]:<10} | {score_student_list["place"][i]:<10}  | {score_student_list["height"][i]:<10} | {score_student_list["weight"][i]:<10}  ')
                ...
                if new_nis in score_student_list["NIS"]:
                    ...
                    if saved == "y":
                        ...
                        if colom_change == "mata pelajaran" :
                            new_mata_pelajaran = input("Enter New mata pelajaran : ")
                            saved_change = input("Apakah Anda Serius Ingin Mengubahnya  ?  y/n ")
                            if saved_change == "y":
